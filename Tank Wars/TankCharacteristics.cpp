...
TankCharacteristic ussrT46 = { L"T-46", "images/T-46.png",
IntRect(0, 0, 100, 48), IntRect(0, 51, 85, 29),
17, 2, 52, 36, 36, 1, 50, 100 };

TankCharacteristic ussrT34 = { L"T-34", "images/T-34.png",
IntRect(0, 0, 112, 56), IntRect(0, 58, 128, 42),
28, 8, 52, 36, 36, 1, 50, 100 };

TankCharacteristic ussrKV1 = { L"ÊÂ-1", "images/KV1.png",
IntRect(0, 0, 120, 60), IntRect(0, 61, 102, 36),
26, 6, 52, 36, 36, 1, 50, 100 };

TankCharacteristic ussrIS = { L"ÈÑ", "images/IS.png",
...
TankCharacteristic germanyPZIV = { L"PZ IV", "images/PZIV.png",
IntRect(0, 0, 110, 59), IntRect(0, 60, 123, 53),
36, 0, 50, 25, 25, 10, 10, 100 };

TankCharacteristic germanyTiger1 = { L"Tiger I", "images/TigerI.png",
IntRect(0, 0, 120, 68), IntRect(0, 69, 142, 46),
22, 1, 50, 25, 25, 10, 10, 100 };

TankCharacteristic germanyTiger2 = { L"Tiger II", "images/TigerII.png",
IntRect(0, 0, 140, 72), IntRect(0, 74, 190, 54),
36, 7, 50, 25, 25, 10, 10, 100 };

TankCharacteristic germanyMaus = { L"Maus", "images/Maus.png",
